            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--tone-bg)] text-[var(--tone-text)] transition-transform duration-300 group-hover:scale-110">
